...
export default function Projects({ projects }: Props) {
  console.log("a7a", urlFor(projects[0]?.image));
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
            ...
            <div className="space-y-5 md:space-y-10 px-0 md:px-10 max-w-6xl">
              ...
              <div className="flex items-center space-x-2 justify-center ">
                {project?.technologies.map((technology) => (
                  <div className="relative" key={technology._id}>
                    <Image
                      fill
      ...
      <div className="w-full absolute top-[20%] md:top-[30%] bg-[#F7AB0A]/40 left-0 h-[500px] -skew-y-12"></div>
    </motion.div>
  );
}
